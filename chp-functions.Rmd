...
A tail function that gets the last n rows of a data frame
A function that calculated uncertainty intervals from a median and expected uncertainty
A function that calculated population growth
