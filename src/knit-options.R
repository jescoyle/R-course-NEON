...
# This function sets working directory for code chunks to the student workbook project.
...
## they can be easily identified and deleted.  The
## working directory when the lessons are generated is the root so the
## figures need to be saved in images.
