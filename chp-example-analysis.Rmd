...
**THIS LESSON IS NOT READY FOR LEARNERS**
...
4. Insider the derived data folder, create a folder named `output`. The code from this lesson will generate figures that will save into this folder.
...
**Goal 2:** Relate the abundance and diversity of macroinvertebrates to water temperature at each site on the dates when samples were collected.
