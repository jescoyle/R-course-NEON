...
2	2	describe the contents of the windows in an RStudio session	learners will
...
Almost anything though it is not always the best tool for every job. The simplist thing it can do is calculations...
