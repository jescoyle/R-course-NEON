...
**Important:** Variable names can contain letters, numbers, underscores and periods but no spaces. They must start with a letter or a period followed by a letter (they cannot start with a number nor an underscore).
...
> ::: {.challenge}
> **Try this:** Can you predict what each of the following lines of code will return?
> ```{r eval = FALSE}
> c("Betsy", firstNames)
> firstNames[4:1]
> ages[c(2, 4)]
