...
For example, what exactly are these data that we are working with?
...
##              Teakettle Creek NEON site from Apr - Oct 2021.
...
This lesson utilizes data from @NEON-surfwatertemp.
