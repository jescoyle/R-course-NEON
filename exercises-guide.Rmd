...
This page provides links to all exercise files. This is a useful way to access individual exercise files if you need to add them to the student workbook RStudio project.

NOTE: THE FOLLOWING LINKS DO NOT WORK YET. If you need the exercises files, download the workbook again.
