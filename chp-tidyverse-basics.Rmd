...
*!UPDATE THIS TO USE THE NEW SYNETHSIS & MAKE NEW SCRIPT!*
...
solution.6 <- TSW_30min |>
  mutate(week = week(startDateTime)) |>
...
The synthesis section generates a table `site_summary` with abundance and diversity data for each collection date at each site. The table you created in exercise `r .chp_num`.3 summarizes monthly mean surface water temperature at each site.
