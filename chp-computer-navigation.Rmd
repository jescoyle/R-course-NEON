...
You will also see a mostly empty folder in the Files window. There should be one file with the name of the project: R-course-NEON.Rproj
...
> 5. Observe the Files window in RStudio. What has changed?
...
> 
> Use the File window in RStudio or your computer's file browser to create the following folders inside the R-course-NEON folder:
>
>   * doc
>   * data 
>   * results
...
::: {.solution}
> #### Solution:
> The Files window in RStudio should now look like this:
...
2. Unzip the folder you downloaded. Instructions for how to unzip folders are located [here for Mac]() and [here for Windows]().
3. Open the RStudio project using the .Rproj file, then use the File window in RStudio to explore the directory structure of this project.
