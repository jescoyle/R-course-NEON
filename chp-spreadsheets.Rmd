...
Before you begin this lesson, use spreadsheet software (i.e. Excel) to open the file `survey_data_spreadsheet_messy.xls` from the `data/Spreadsheets` folder of the R-course-NEON workbook. 
