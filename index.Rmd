...
## Overview
This is a self-paced tutorial adapted from [Data Carpentry](http://datacarpentry.org/){target="_blank" rel="noopener noreferrer"} and [Software Carpentry](http://software-carpentry.org/){target="_blank" rel="noopener noreferrer"} that teaches biologists basic data science and computing skills using  [National Ecological Observation Network](http://neonscience.org){target="_blank" rel="noopener noreferrer"} data. It was developed for use in an upper division Biology course at Saint Mary's College of California. 
...
The chapters are arranged in a progression with later chapters generally requirement knowledge from earlier chapters. Readers who wish to skip chapters should consult the following flow chart which shows how contents of the chapters depend on each other:



## Open Educational Resource

These materials will be published open access, but they are currently under development and are **not currently ready for adaptation.** The book will likely be converted to a Quarto document when relased for the public.

### Acknowledgements
Thank you to [Data Carpentry](http://datacarpentry.org/){target="_blank" rel="noopener noreferrer"} and [Software Carpentry](http://software-carpentry.org/){target="_blank" rel="noopener noreferrer"} for providing open and remixable materials for scientists learning programming and data science. This course draws heavily from the [Data Carpentry for Biologists](https://datacarpentry.org/semester-biology/){target="_blank" rel="noopener noreferrer"} and [R for Reproducible Scientific Analysis](https://swcarpentry.github.io/r-novice-gapminder/){target="_blank" rel="noopener noreferrer"}.
